      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          <Typography variant="h4" className={classes.bigSpace} color="primary">
             Brittany Wood A Passionate Artist
          </Typography>
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            Find myself doing web and applications for computer and mobile devices, learning and doing tutorials is always a great learning curve for myself to broaden my horizon on Web and Software Technology.
          </Typography>
        </div>
